...
public class MyAdapterSuaChuyenBay extends BaseAdapter {
    LayoutInflater inflater;
    TextView textView;
    ImageView imageView;
    Context context;

    public MyAdapterSuaChuyenBay(Context context)
    {
    ...
    @Override
    public int getCount() {
        return SuaChuyenBay.flights.size();
    }

    @Override
    public Object getItem(int i) {
        return SuaChuyenBay.flights.get(i);
    }

    @Override
    public long getItemId(int i) {
        return SuaChuyenBay.flights.get(i).getId();
    }
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        textView.setText(SuaChuyenBay.flights.get(i).getDiem_di());
        textView = (TextView) view.findViewById(R.id.tv_diem_den);
        textView.setText(SuaChuyenBay.flights.get(i).getDiem_den());
        textView = (TextView) view.findViewById(R.id.tv_time_di);
        textView.setText(SuaChuyenBay.flights.get(i).getTime_di());
        textView = (TextView) view.findViewById(R.id.tv_time_den);
        textView.setText(SuaChuyenBay.flights.get(i).getTime_den());
        textView = (TextView) view.findViewById(R.id.tv_gia_ve);
        textView.setText(Double.toString(SuaChuyenBay.flights.get(i).getGia_ve()));
